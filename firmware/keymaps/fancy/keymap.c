...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_split_3x5_3(
            ...
            LT(2,KC_TAB), LALT_T(KC_BSPC), KC_AUDIO_MUTE,   KC_BTN1, LALT_T(KC_SPC), TD(TD_L1)
    ...
    [2] = LAYOUT_split_3x5_3(
            ...
            LSFT_T(KC_F1), KC_F2, KC_F3, KC_F4, TO(3),        KC_MUTE, KC_VOLD, KC_VOLU, KC_NO, KC_RSFT,
                          TG(2), LALT_T(KC_PSCR), ___,        ___, LALT_T(KC_MPLY), TD(TD_MD_NX_PR)
    ...
    [3] = LAYOUT_split_3x5_3(
            ...
            KC_NO, KC_NO, KC_NO, KC_NO, TG(3),              KC_P0, KC_P1, KC_P2, KC_P3, KC_DOT,
                              TO(2), ___, ___,              ___, KC_BSPC, KC_ESC
