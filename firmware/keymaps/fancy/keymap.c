...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_split_3x5_3(
            ...
            KC_LSFT, ___, ___, KC_LBRC, LT(3,KC_RBRC),       KC_EQL, KC_MINS, __T, __T, __T,
                                        __T, __T, __T,       KC_BTN2, __T, TG(1)
            ),

    [2] = LAYOUT_split_3x5_3(
            LGUI_T(KC_F9), KC_F10, KC_F11, KC_F12, KC_BTN2,    KC_HOME, KC_PGDN, KC_PGUP, KC_END, KC_LGUI,
            LCTL_T(KC_F5), KC_F6, KC_F7, KC_F8, KC_BTN1,       KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_CAPS,
            LSFT_T(KC_F1), KC_F2, KC_F3, KC_F4, TO(3),         KC_MUTE, KC_VOLD, KC_VOLU, ___, KC_RSFT,
                               TG(2), LALT_T(KC_PSCR), __T,    KC_BTN2, LALT_T(KC_MPLY), TD(TD_MD_NX_PR)

            ),

    [3] = LAYOUT_split_3x5_3(
            ___, KC_HOME, KC_UP, KC_PGUP, KC_NUM,           KC_PSLS, KC_P7, KC_P8, KC_P9, KC_PMNS,
            ...
            ___, KC_MUTE, KC_VOLD, KC_VOLU, TG(3),          KC_P0, KC_P1, KC_P2, KC_P3, KC_DOT,
                                          ___, __T, __T,    __T, LALT_T(KC_BSPC), KC_ESC
