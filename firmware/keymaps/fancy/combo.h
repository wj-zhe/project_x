...
const uint16_t PROGMEM ef_combo[] = {KC_E, LCTL_T(KC_F), COMBO_END};
const uint16_t PROGMEM rg_combo[] = {KC_R, KC_G, COMBO_END};
const uint16_t PROGMEM uh_combo[] = {KC_U, KC_H, COMBO_END};
const uint16_t PROGMEM ij_combo[] = {KC_I, LCTL_T(KC_J), COMBO_END};
...
/* const uint16_t PROGMEM sf_combo[] = {KC_S, LCTL_T(KC_F), COMBO_END}; */
const uint16_t PROGMEM df_combo[] = {KC_D, LCTL_T(KC_F), COMBO_END};
const uint16_t PROGMEM jk_combo[] = {LCTL_T(KC_J), KC_K, COMBO_END};
const uint16_t PROGMEM jkl_combo[] = {LCTL_T(KC_J), KC_K, KC_L, COMBO_END};
const uint16_t PROGMEM down_up_right_combo[] = {KC_DOWN, KC_UP, KC_RIGHT, COMBO_END};
/* const uint16_t PROGMEM jl_combo[] = {LCTL_T(KC_J), KC_L, COMBO_END}; */
const uint16_t PROGMEM kl_combo[] = {KC_K, KC_L, COMBO_END};
const uint16_t PROGMEM lsln_combo[] = {KC_L, KC_SCLN, COMBO_END};
...
const uint16_t PROGMEM motion_combo[] = {LCTL_T(KC_DOWN), KC_UP, KC_RIGHT, COMBO_END};
